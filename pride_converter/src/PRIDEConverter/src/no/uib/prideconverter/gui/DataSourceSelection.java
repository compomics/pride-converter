...
public class DataSourceSelection extends javax.swing.JFrame {
    ...
    public DataSourceSelection(PRIDEConverter prideConverter, Point location) {
        ...
        if (prideConverter.getProperties().getDataSource().equalsIgnoreCase("ms_lims")) {
            ...
            descriptionJEditorPane.setText("<font size=\"3\" face=\"Tahoma\"><br><b>The PRIDE Converter</b><br><br>" +
                    "The PRIDE Converter converts mass spectrometry data sets into valid PRIDE XML<br>" +
                    "to be submitted to the online <a href=\"http://www.ebi.ac.uk/pride/\">PRIDE repository</a>.<br><br>" +
                    ...
                    "in the lower left corner of each frame.<br><br><br>" +
                    "More information about the PRIDE Converter can be found here: " +
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Data Source", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 0)));
        ...
        descriptionJPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Data Source Description", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(0, 0, 0)));
