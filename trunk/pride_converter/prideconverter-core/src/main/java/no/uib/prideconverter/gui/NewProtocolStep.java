...
public class NewProtocolStep extends javax.swing.JDialog implements OLSInputable {
    ...
    private void editJMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editJMenuItemActionPerformed
        ...
        this.setCursor(new java.awt.Cursor(java.awt.Cursor.WAIT_CURSOR));
        new OLSDialog(this, true, "protocolSteps", prideConverter.getUserProperties().getLastSelectedOntology(), selectedRow, null);
        this.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void helpJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_helpJButtonActionPerformed
        ...
        new HelpWindow(this, getClass().getResource("/no/uib/prideconverter/helpfiles/NewProtocolStep.html"));
