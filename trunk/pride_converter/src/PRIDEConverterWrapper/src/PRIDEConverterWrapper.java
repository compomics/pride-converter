...
public class PRIDEConverterWrapper {
    ...
    private String jarFileName = "PRIDEConverter_v1.13.3.jar";
    private String prideConverterSourceJarFileName = "pride_converter_v1.13.3.jar";
    ...
    private void launch() throws Exception {
        ...
        if (!error) {
            ...
            // see if any jvm options are given
            ...
            if (isWindows) {
                cmdLine = javaHome + "java " + options + " -classpath \"" + path +
                        prideConverterSourceJarFileName +
                        "\" no/uib/prideconverter/PRIDEConverter";
            } else {
                cmdLine = javaHome + "java " + options + " -classpath " + path +
                        prideConverterSourceJarFileName +
                        " no/uib/prideconverter/PRIDEConverter";
            ...
            try {
                ...
                // catch any errors and send them to a log file
     ...
     * Use this as the main class in the jar file.
     * 
     * @param args 
     */
